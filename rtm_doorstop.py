...
fieldnames = ["UID", "Name", "Method", "Verification Plan", "Status"]
    ...
    table_data = [
        {
            ...
            "Method": item.verification_method, # Test Methods for verification (ex. Test, Inspection, Analysis, Demonstration)
            "Status": item.verification_status, # Verification status
